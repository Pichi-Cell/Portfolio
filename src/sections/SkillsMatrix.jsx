  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="mb-6 grid gap-5 border-y border-[#5D4037]/20 py-5 sm:mb-8 sm:gap-6 sm:py-6 md:grid-cols-[0.7fr_1fr] md:items-end">
          <div>
        ...
        <div className="grid grid-cols-1 border-l border-t border-[#5D4037]/20 sm:grid-cols-2 xl:grid-cols-3">
          {entries.map(([domain, items]) => (
            ...
            >
              ...
              <ul className="space-y-0 border-t border-[#5D4037]/15">
                {items.map((skill) => (
                  <li
                    key={skill}
                    className="border-b border-[#5D4037]/15 py-2.5 font-mono text-[11px] uppercase leading-5 tracking-[0.06em] text-[#5D4037] sm:py-3 sm:text-xs sm:tracking-[0.08em]"
                  >
                    {skill}
                  </li>
                ))}
