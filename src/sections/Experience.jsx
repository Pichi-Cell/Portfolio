...
const Experience = ({ experience, ui }) => {
  return (
    <section
      id="experience"
      className="scroll-mt-28 px-5 py-24 md:px-8 lg:py-32"
    >
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 grid gap-6 md:grid-cols-[0.85fr_1fr] md:items-end">
          <div>
            <p className="mb-3 font-mono text-xs uppercase tracking-[0.28em] text-[#5D4037]">
              The Liner Notes
            </p>
              ...
              <div className="grid gap-8 xl:grid-cols-[0.7fr_1fr]">
                ...
                <ul className="space-y-4">
                  {exp.bullets.map((bullet) => (
                    <li
                      key={bullet}
                      className="grid grid-cols-[1rem_1fr] gap-3 text-sm leading-7 text-[#5D4037] md:text-base"
                    >
